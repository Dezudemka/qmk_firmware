...
#define FUCO 4
#define FUCC 5
#define PUBGCROUCHJUMP 6
#define PUBGCROUCHJUMP2 7
...
#define M_CRJP M(PUBGCROUCHJUMP)
#define M_CRJP2 M(PUBGCROUCHJUMP2)
...
[1] = {
	...
	{KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, M_CRJP,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS}
},

// Fn2 Layer
[2] = {
	{KC_TRNS, KC_MAIL, KC_CALC, KC_MYCM, KC_WHOM, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_WAKE, KC_SLEP, KC_PWR },
...
[3] = {
	{KC_TRNS, EF_DEC,  EF_INC,  H1_DEC,  H1_INC,  H2_DEC,  H2_INC,  KC_TRNS, KC_TRNS, ES_DEC,  ES_INC,  BR_DEC,  BR_INC,  KC_TRNS},
	{KC_TRNS, KC_TRNS, KC_TRNS, S1_DEC,  S1_INC,  S2_DEC,  S2_INC,  KC_TRNS, KC_TRNS, RGB_HUI, RGB_SAI, RGB_VAI, RGB_TOG, KC_TRNS},
	{KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RGB_HUD, RGB_SAD, RGB_VAD, RGB_MOD, KC_TRNS},
...
const macro_t *action_get_macro(keyrecord_t *record, uint8_t id, uint8_t opt)
{
    if (record->event.pressed)
    {
        switch(id)
        {
            ...
            // case PUBGCROUCHJUMP:
            //     return MACRO(D(SPACE), W(3), D(C), W(100), U(C), U(SPACE), U(W), D(W), W(250), W(250), W(250), U(W), END);
            // case PUBGCROUCHJUMP2:
            //     return MACRO(D(W), W(250), D(SPACE), D(C), W(100), U(C), U(SPACE), U(W), D(W), W(250), W(250), W(250), U(W), END);
        }
    }
    return MACRO_NONE;
};
